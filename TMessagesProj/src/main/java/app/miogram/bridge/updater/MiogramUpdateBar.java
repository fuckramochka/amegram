...
public class MiogramUpdateBar extends FrameLayout implements MiogramDownloadManager.DownloadListener {
    ...
    private void init(Context context) {
        setClickable(true);
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(12), Theme.getColor(Theme.key_windowBackgroundWhite)));
        setElevation(AndroidUtilities.dp(4));
        setPadding(AndroidUtilities.dp(12), AndroidUtilities.dp(6), AndroidUtilities.dp(12), AndroidUtilities.dp(6));
        ...
        content.addView(iconView, LayoutHelper.createLinear(20, 20, Gravity.CENTER_VERTICAL, 0, 0, 8, 0));
        ...
        textContainer.addView(subtitleView, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, 0, 1, 0, 2));

        progressBar = new ProgressBar(context, null, android.R.attr.progressBarStyleHorizontal);
        progressBar.setMax(100);
        progressBar.setProgress(0);
        textContainer.addView(progressBar, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, 3));
        ...
        closeView.setPadding(AndroidUtilities.dp(4), AndroidUtilities.dp(4), AndroidUtilities.dp(4), AndroidUtilities.dp(4));
        ...
        content.addView(closeView, LayoutHelper.createLinear(24, 24, Gravity.CENTER_VERTICAL, 6, 0, 0, 0));
            ...
            public boolean onTouch(View v, android.view.MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case android.view.MotionEvent.ACTION_MOVE:
                        ...
                        if (dy > AndroidUtilities.dp(4) || isDragging) {
                            isDragging = true;
                    ...
                    case android.view.MotionEvent.ACTION_CANCEL:
                        if (isDragging) {
                            isDragging = false;
                            if (getTranslationY() > AndroidUtilities.dp(36)) {
                                hideGlobalBar();
                            } else {
    ...
    public static void showGlobalBar() {
        mainHandler.post(() -> {
            ...
            if (currentBarInstance == null) {
                ...
                int bottomMargin = AndroidUtilities.dp(16);
                lp.setMargins(AndroidUtilities.dp(14), 0, AndroidUtilities.dp(14), bottomMargin);
